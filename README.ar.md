...
| رسالة «الذاكرة غير كافية» | أغلق بعض البرامج أو اختر نموذجاً أصغر. |
...
| `npm run dev` | يشغّل التطبيق في وضع التطوير |
...
- الاتصال **الوحيد** بالإنترنت هو تنزيل النموذج لمرة واحدة من [Hugging Face Hub](https://huggingface.co/Systran) العام.
